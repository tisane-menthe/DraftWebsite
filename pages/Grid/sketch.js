...
//Color of grid & logo
let my_tint_rot = "rgba(11, 255, 212,0.7)";
let my_tint_lin = "rgba(11, 255, 212,0.2)";

//let my_tint_lin = "rgba(188, 255, 198,0.1)";
...
tint("rgba(250, 60, 160, 0.8)");
  image(Unfold, xImg, -height/2 );
  xImg+=0.5;
  let xRep = -Unfold.width + xImg;
  image(repeatImg, xRep, -height/2);

  if(xImg > width/2) {
      xImg = -width/2;
  }

  image(Displace, xImg_b, height/2 - 50);
  xImg_b-=2;
  let xRep_b = -Unfold.width + xImg_b;
  image(repeatImg_b, xRep_b, height/2 - 50);
