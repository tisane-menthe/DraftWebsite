...
let textColor = "rgba(190, 190, 190, 1)";
...
function setup() {
  ...
  section.push(new CreateSection("Volunteers and projects", 0, 50, CENTER, CENTER, 200, 200));

  
  section.push(new CreateSection("About", -width/2 + 200, height/3, CENTER, CENTER, 200, 140));
  ...
  ellipses.push(new CreateEllipse(section[1].posX, section[1].posY + section[1].boxHeight/2, radius));
  ellipses.push(new CreateEllipse(section[2].posX, section[2].posY - section[2].boxHeight/2 - radius/2, radius));
  ellipses.push(new CreateEllipse(section[3].posX, section[3].posY - section[3].boxHeight/2, radius));
...
function draw() {
 ...
 background('rgba(11, 255, 212,0.3)');
  noStroke();
